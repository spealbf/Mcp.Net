...
public static class ConsoleBanner
{
    ...
    public static void DisplayHelp()
    {
        ...
        Console.WriteLine("============================");
        Console.WriteLine("\nUsage: dotnet run --project Mcp.Net.Examples.LLM [options]\n");
        ...
        Console.WriteLine("\nExamples:");
        Console.WriteLine("  dotnet run --project Mcp.Net.Examples.LLM --provider anthropic");
        Console.WriteLine(
            "  dotnet run --project Mcp.Net.Examples.LLM --provider openai --model gpt-4o"
        );
        Console.WriteLine(
